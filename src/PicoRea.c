...
/*------------------------------------------------------------------------*/
/*  COM                                                                   */
/*     expr-stack: [NAM EXP ... EXP NBR BOOL EXP] -> [NAM EXP ... EXP EXP NBR BOOL] */
/*     cont-stack: [... ... ... ... CNT COM] -> [... ... ... CNT COM EXP] */
/*                                                                        */
/*     expr-stack: [NAM EXP ... EXP NBR EXP] -> [... ... ... ... NAM TAB] */
/*     cont-stack: [... ... ... ... CNT COM] -> [... ... ... ... CNT APL] */
/*                                                                        */
/*     expr-stack: [NAM EXP ... EXP NBR BOOL EXP] -> [... ... ... ... NAM TAB] */
...
static _NIL_TYPE_ COM(_NIL_TYPE_) //comma list
{
	...
	_stk_claim_();
	_stk_pop_EXP_(exp);
	_stk_pop_EXP_(aplication_or_not);
	_stk_peek_EXP_(nbr);
	_stk_poke_EXP_(exp);
	...
	case _RBR_TOKEN_:
		...
		_stk_push_EXP_(tab);
		if(_mem_is_same_(aplication_or_not, _TRUE_))
			_stk_poke_CNT_(APL);
		else
			_stk_zap_CNT_();
		break;
	case _COM_TOKEN_:
		...
		_stk_push_EXP_(nbr);
		_stk_push_EXP_(aplication_or_not);
		_stk_push_CNT_(EXP);
		break;
	default:
